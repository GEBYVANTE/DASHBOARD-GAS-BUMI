...
# -------------------------
st.sidebar.title("Monitoring kegiatan Sales City Gas di Area Pasuruan - Sales and Operation Region III")
page = st.sidebar.radio("Navigation", ["Dashboard Utama", "Peta Radius", "Data & Catatan", "Settings", "Peta Cluster",])
